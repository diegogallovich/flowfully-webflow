...
if (window.location.hostname === 'www.flowfully.io') {
  ...
  posthogScript.innerHTML = `
    ...
    posthog.init('phc_EI4SC6drUovAXL70n6WXpWBvsDb172OXnFChKMkb2Xx',{api_host:'https://us.i.posthog.com', person_profiles: 'identified_only' // or 'always' to create profiles for anonymous users as well
      });
  `;
